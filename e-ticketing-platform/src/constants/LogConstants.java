...
public class LogConstants {
    ...
    public static final String BUY_TICKET_SUCCESS = "Ticket for event %s id : %s was successfully bought.";

    public static final String RETURN_TICKET_FAILED = "Returning ticket failed due to: %s ";

    public static final String RETURN_TICKET_SUCCESS = "Ticket for event %s id : %s was successfully returned.";
